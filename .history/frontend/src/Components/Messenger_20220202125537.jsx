...
const useStyles = makeStyles(theme => ({
    ...
    darkModeBgSidebar : {backgroundColor:"#2e3638"},
    darkModeChatFeed:{backgroundColor:"#121212e6"},
            ...
            <Container maxWidth="xl" className={classes.root}>
                ...
                <Grid container>
                    ...
                    {currentFriend ? <><Grid item xs={12} md={8}>
                        ...
                        <Grid item xs={12} md={2}>
                            <Box className={`${classes.chatItems} ${localStorage.isDark ? classes.darkModeBgSidebar : classes.bgSideBar}`}>
