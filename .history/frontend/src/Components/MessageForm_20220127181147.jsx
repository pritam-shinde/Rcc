...
const MessageForm = ({ sendMessage, imageSend, isTyping, typingMessageStatus }) => {
    ...
    console.log(typingMessageStatus.senderName, " is typing...")
    return (
        <>
            <Box style={{ borderTop: "1px solid lightgrey", borderBottom: "1px solid lightgrey", }} id="message_form" >
                ...
                <Box py={2} px={2}>
                    ...
                    <Box mt={1}>
                        <small className="text-muted" style={{ fontSize: "0.7535rem" }}>{typingMessageStatus.senderName} is typing...</small>
                    </Box>
                </Box>
            </Box>
        </>
