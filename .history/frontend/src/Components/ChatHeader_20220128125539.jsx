        ...
        <>
            <Box py={1} px={2} className={`${classes.root}`} >
                <Box className='d-flex'>
                    <Badge variant='dot' style={{backgroundColor: userActive.userId === currentFriend._id ? "green" : "red"}}><Avatar src={`./image/${currentFriend.image}`} style={{ marginRight: "0.5rem" }} /></Badge>
