...
const ChatHeader = ({ currentFriend, activeUser }) => {
    ...
    return (
        <>
            <Box py={1} px={2} className={`${classes.root}`} style={{backgroundColor: localStorage.getItem('isDark') ? "#181d25" : "#fff", borderBottom: localStorage.getItem('isDark') ? "1px solid #555" : "1px solid lightgrey", borderTop:"none",}} >
