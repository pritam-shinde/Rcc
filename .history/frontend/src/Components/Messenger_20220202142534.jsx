            ...
            <Container maxWidth="xl" className={classes.root}>
                ...
                <Grid container>
                    ...
                    {currentFriend ? <><Grid item xs={12} md={8}>
                        ...
                        <Grid item xs={12} md={2}>
                            <Box className={`${classes.chatItems} ${localStorage.isDark ? classes.darkModeBgRightSidebar : classes.bgSideBar}`} style={{border: localStorage.getItem('isDark') ? "1px solid #222" : "1px solid lightgrey", borderCollapse:"collapse", borderTop:"none", borderBottom:"none"}}>
