...
const ChatList = ({ friends, getCurrentFriend, currentFriend }) => {
    ...
    return (
        <>
            <Box className={classes.sec} style={{backgroundColor: localStorage.getItem('isDark') ? "#05080a94" :"#fff",borderBottom: localStorage.getItem('isDark') ? "#222" :"1px solid lightgrey"}}>
