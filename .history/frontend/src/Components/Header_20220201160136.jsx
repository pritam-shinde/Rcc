...
import { AppBar, Toolbar, Link, Box, IconButton, Avatar, Popover, Divider, Button, Card, CardHeader, CardContent, CardActions, makeStyles } from '@material-ui/core';
                        ...
                        <Box py={2} style={{ width: "12rem" }} >
                            <Box px={2} className="d-flex justify-content-between align-items-center py-2">
                                ...
                                <Box>
                                    ...
                                    <Popover open={isModalVisible} anchorOrigin={{ vertical: 'top-center', horizontal: 'left-center', }}>
