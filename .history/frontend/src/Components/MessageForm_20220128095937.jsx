                ...
                <Box py={2} px={2}>
                    <form onSubmit={(e) => { e.preventDefault(); sendMessage(message); setMessage("");  }}>
                        <Box className={classes.root}>
                            <input type="text" placeholder='Message' className='form-control' multiple onChange={(e) => { setMessage(e.target.value); isTyping(true, message) }} value={message} onBlur={()=> isTyping(false, message)} />
