            ...
            <Container maxWidth="xl" className={classes.root}>
                ...
                <Grid container>
                    <Grid item xs={12} md={2}>
                        <Box className={`${classes.chatItems} ${localStorage.getItem('isDark') ? classes.darkModeLeftSidebar : classes.bgSideBar}`} style={{border: localStorage.getItem('isDark') ? "1px solid #555" : "1px solid lightgrey"}} >
                    ...
                    {currentFriend ? <><Grid item xs={12} md={8}>
                        <Box className={`${classes.chatItems} ${localStorage.getItem('isDark') ? classes.darkModeChatFeed : classes.lightModeChatFeed}`} style={{border: localStorage.getItem('isDark') ? "1px solid #555" : "1px solid lightgrey",borderCollapse:"collapse"}} >
                        ...
                        <Grid item xs={12} md={2}>
                            <Box className={`${classes.chatItems} ${localStorage.isDark ? classes.darkModeBgRightSidebar : classes.bgSideBar}`}>
                                <ChatSetting friends={friends} currentFriend={currentFriend} activeUser={activeUser} message={message} myInfo={myInfo} />
                            </Box>
                        </Grid></> : <>
                        <Grid item xs={12} md={10}>
                            <Box className={`${classes.chatItems} d-flex justify-content-center align-items-center flex-column`} style={{border: localStorage.getItem('isDark') ? "1px solid #555" : "1px solid lightgrey", borderCollapse:"collapse"}}>
