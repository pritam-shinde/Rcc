...
const useStyles = makeStyles(theme => ({
    ...
    darkModeHeader: {backgroundColor:"#121212e6"}
}))

const Header = ({ myInfo, logout, handleDarkMode }) => {
    ...
    return (
        <>
            <AppBar position='static' style={{ boxShadow: "none" }} className={localStorage.getItem('isDark') ? classes.darkModeHeader : classes.header}>
                <Toolbar >
                    ...
                    <Popover id={id} open={open} anchorEl={anchorEl} onClose={handleClose} anchorOrigin={{ vertical: 'bottom', horizontal: 'left', }}>
                        <Box py={2} style={{ width: "12rem" }} >
                            ...
                            <Box px={2}>
                                ...
                                <Box>
                                    <IconButton style={{marginRight:"0.7rem"}} onClick={()=> handleDarkMode(false)}>
                                        <MdLightMode />
                                    </IconButton>
