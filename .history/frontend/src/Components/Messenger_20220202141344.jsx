            ...
            <Container maxWidth="xl" className={classes.root}>
                ...
                <Grid container>
                    <Grid item xs={12} md={2}>
                        <Box className={`${classes.chatItems} ${localStorage.getItem('isDark') ? classes.darkModeLeftSidebar : classes.bgSideBar}`} style={{border: localStorage.getItem('isDark') ? "1px solid #555" : "1px solid lightgrey",borderTop:"none", borderBottom:"none"}} >
