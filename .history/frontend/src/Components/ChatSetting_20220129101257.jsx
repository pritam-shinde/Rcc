        ...
        <>
            <Box px={1} py={2} className={classes.root}>
                ...
                <Box mt={2}>
                    ...
                    <Divider />
                    <Collapse in={state}>
                        <Box style={{ border: "1px solid red", height: "62vh", overflowY: "scroll", overflowX: "hidden" }}>
                            <List>
                                {
                                    imageMessage.map(msg=>{
                                        return <ListItem key={msg._id}>
                                                    <Box style={{width:"30%", marginRight:"0.5rem"}}>
                                                        <img src={`./image/${msg.message.image}`} alt='attachment' className='img-fluid rounded' />
                                                    </Box>
                                                    <ListItemText primary={msg.message.image} style={{wordWrap:"break-word", fontSize:"0.9375rem", fontWeight: 400}} />
                                        </ListItem>
                                    })
                                }
                            </List>
