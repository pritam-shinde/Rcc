...
const ChatListSecHead = ({ head, icon }) => {
    ...
    return (
        <>
            <Box py={2} px={2} style={{backgroundColor: localStorage.getItem('isDark') ? "#05080a94" :"#fff", borderBottom: localStorage.getItem('isDark') ? "1px solid #222": "1px solid lightGrey", }} >
