                ...
                <div className="media" style={{ width: "100%" }} ref={scrollRef} >
                    ...
                    <div className="media-body">
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                            <div>
                                <h5 className={`${localStorage.getItem('isDark') ? "text-white" : "text-muted"} mt-0` } style={{ fontSize: "0.9375rem", fontWeight: 700, color: "#121212", lineHeight: "1.5rem" }}>{message.senderName}</h5>
                            </div>
                            <div>{convertTime()}</div>
                        </div>
