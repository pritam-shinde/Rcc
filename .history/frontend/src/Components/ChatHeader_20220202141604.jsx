...
const useStyles = makeStyles(theme => ({
    root: { display: "flex", justifyContent: "space-between", boxShadow: "none", borderRadius: "none",},
...
const ChatHeader = ({ currentFriend, activeUser }) => {
    ...
    return (
        <>
            <Box py={1} px={2} className={`${classes.root}`} style={{backgroundColor: localStorage.getItem('isDark') ? "#181d25" : "#fff", border: localStorage.getItem('isDark') ? "1px solid #555" : "1px solid lightgrey", borderTop:"none", borderBottom:"none"}} >
