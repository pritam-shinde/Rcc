            ...
            <Container maxWidth="xl" className={classes.root}>
                ...
                <Grid container>
                    ...
                    {currentFriend ? <><Grid item xs={12} md={8}>
                        <Box className={`${classes.chatItems} ${localStorage.getItem('isDark') ? classes.darkModeChatFeed : classes.lightModeChatFeed}`} style={{border: localStorage.getItem('isDark') ? "1px solid #555" : "1px solid lightgrey"}} >
