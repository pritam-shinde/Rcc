            ...
            <Container maxWidth="xl" className={classes.root}>
                ...
                <Grid container>
                    <Grid item xs={12} md={2}>
                        <Box className={`${classes.chatItems} ${localStorage.getItem('isDark') ? classes.darkModeLeftSidebar : classes.bgSideBar}`} style={{border: localStorage.getItem('isDark') ? "#555" : "lightgrey"}} >
