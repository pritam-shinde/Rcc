...
const useStyles = makeStyles(theme => ({
    ...
    darkModeLeftSidebar: {backgroundColor:"#010e1cdb"}
}))
            ...
            <Container maxWidth="xl" className={classes.root}>
                ...
                <Grid container>
                    <Grid item xs={12} md={2}>
                        <Box className={`${classes.chatItems} ${localStorage.getItem('isDark') ? classes.darkModeLeftSidebar : classes.bgSideBar}`} >
                    ...
                    {currentFriend ? <><Grid item xs={12} md={8}>
                        <Box className={`${classes.chatItems} ${localStorage.getItem('isDark') ? classes.darkModeChatFeed : classes.lightModeChatFeed}`} style={{border: localStorage.getItem('isDark') ? "1px solid #222" : "1px solid lightgrey",borderCollapse:"collapse",borderTop:"none", borderBottom:"none"}} >
