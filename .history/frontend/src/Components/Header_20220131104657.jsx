...
import { AppBar, Toolbar, Link, Box, IconButton, Avatar, Popover, Divider, Button, makeStyles } from '@material-ui/core';
            ...
            <AppBar position='static' style={{ boxShadow: "none" }}>
                <Toolbar className={classes.header}>
                    ...
                    <Popover id={id} open={open} anchorEl={anchorEl} onClose={handleClose} anchorOrigin={{ vertical: 'bottom', horizontal: 'left', }}>
                        <Box style={{ width: "12rem" }} className='bg-dark'>
                            <Box px={2} py={2} className="d-flex justify-content-between align-items-center py-2">
                            ...
                            <Divider />
                            <Box px={2}>
                                <Button variant="contained" color="primary" size='large'>Upgrade Now</Button>
