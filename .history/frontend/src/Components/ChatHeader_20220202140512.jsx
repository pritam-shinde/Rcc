...
const useStyles = makeStyles(theme => ({
    root: { display: "flex", justifyContent: "space-between", boxShadow: "none", borderRadius: "none", borderBottom: "1px solid lightgrey",  },
...
const ChatHeader = ({ currentFriend, activeUser }) => {
    ...
    return (
        <>
            <Box py={1} px={2} className={`${classes.root}`} style={{backgroundColor: localStorage.getItem('isDark') ? "#181d25" : "#fff"}} >
