...
const ChatListSecHead = ({ head, icon }) => {
    ...
    return (
        <>
            <Box py={2} px={2} className={classes.secHead} style={{backgroundColor: localStorage.getItem('isDark') ? "#01040eb3" :"#fff", borderBottom: localStorage.getItem('isDark') ? "1px solid #222": "1px solid lightGrey", }} >
