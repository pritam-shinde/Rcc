                                                ...
                                                <Box className='d-flex align-items-center'>
                                                    <Box mr={1}>
                                                        <Badge variant='dot' color="primary">
                                                            <Avatar src={`./image/${myInfo.image}`} style={{ height: "5rem", width: "5rem" }} />
                                                        </Badge>
                                                    </Box>
                                                    <Box>
                                                        <h6>{myInfo.username ? myInfo.username : null}</h6>
                                                    </Box>
                                                </Box>
                                            </CardContent>
                                            <Divider />
                                            <CardActions>
                                                <Box className="d-flex justify-content-around align-items-center" py={2}>
                                                    <Box>
                                                        Nonstop
                                                    </Box>
                                                    <Box>
                                                        adityaj.nonstop@gmail.com
                                                    </Box>
                                                </Box>
                                            </CardActions>
                                        </Card>
