...
const ChatList = ({ friends, getCurrentFriend, currentFriend }) => {
    ...
    return (
        <>
            <Box className={classes.sec} style={{backgroundColor: localStorage.getItem('isDark') ? "#01040e" :"#fff",borderBottom: localStorage.getItem('isDark') ? "#222" :"1px solid lightgrey"}}>
